...
<head>
    ...
    <title>Calorix - Nutrición Personalizada</title>
...
<!-- Navbar fija con fondo completo y sombra -->
...
<!-- Agrega un margen superior en el contenido para que no quede oculto debajo del navbar -->
<main class="pt-20">
    <!-- Tu contenido aquí -->
</main>
...
<main class="px-6 py-12 max-w-7xl mx-auto">
        ...
        <div class="space-y-8" data-aos="fade-right">
            ...
            <div class="grid grid-cols-3 gap-8 pt-8">
                <div class="space-y-2" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="text-sm text-gray-600 bg-[#e8f5d5] px-3 py-1 rounded-full inline-block">
                        Satisfacción
                    </div>
                </div>
                <div class="space-y-2" data-aos="fade-up" data-aos-delay="400">
                    <div class="text-4xl font-bold text-gray-900">500+</div>
                    <div class="text-sm text-gray-600">Planes personalizados</div>
                </div>
                <div class="space-y-2" data-aos="fade-up" data-aos-delay="600">
                    <div class="text-4xl font-bold text-gray-900">10K+</div>
    ...
    <!-- Añade esto justo antes del cierre del </main> -->
    <!-- Sección de bienestar con animaciones -->
...
<!-- Añade este footer al final de la página, justo antes del cierre de </body> -->
